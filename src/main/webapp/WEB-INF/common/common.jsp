...
<link rel="shortcut icon" href="/image/icon3.png" />
<link rel="apple-touch-icon" href="/image/icon3.png" />
...
<script type="text/javascript" src="/include/js/jquery-3.7.0.min.js"></script>
